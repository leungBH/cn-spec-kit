...
> 本文件汇总 cn-spec-kit 中所有可用于 **Step 4.5 需求文档生成** 的需求文档模板。
> 每个模板在 `templates/` 目录下都有完整的 Markdown 模板源文件，Step 4.5 在执行时会先读取本索引向用户展示可用模板列表，再按用户选择读取对应模板源文件生成产物。
...
如果用户没有显式选择模板，Step 4.5 按以下规则自动推荐：
